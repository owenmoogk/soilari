...
This model is used to recommend specific fertilizers given soil conditions. The input for the model for each characteristic is the current soil and the ideal soil
"""
